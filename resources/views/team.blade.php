    ...
    <div class="container">
      <div class="page-banner-block">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active"><a>Partners</a></li>
        </ol>
      </div>
    </div>
  </div>
  ...
  <div id="team" class="team-main-block">
    <div class="container">
      <div class="section text-center">
        <h3 class="section-heading">Our Awesome Partners</h3>
      </div>
      <div class="row">
        @if ($teams)
          @foreach ($teams as $team)
            <div class="col-md-3 col-sm-6">
              <div class="team-block text-center">
                <div class="team-img">
                  <a href="{{$team->links}}"><img  src="{{asset('images/teams')}}/{{$team->photo}} " class="img-responsive" alt="team">
