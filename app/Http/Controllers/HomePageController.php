...
class HomePageController extends Controller
{
    ...
    public function index()
    {
        ...
        $team_lists = Team::pluck('name', 'id')->all();
        ...
        return view('index', compact('galleries', 'services', 'team_lists', 'socials', 'facts', 'testimonials', 'washing_prices', 'washing_includes', 'washing_plans', 'washing_plan_lists', 'vehicle_company_lists', 'vehicle_modal_lists', 'contacts', 'vehicle_type_lists', 'blogs', 'clients', 'opening_times', 'company_socials', 'vehicle_types'));
    }
    ...
    public function store(Request $request)
    {
      ...
      if (Auth::check()) {
        ...
        $team = Team::findOrFail($input['team_id'])->name;
